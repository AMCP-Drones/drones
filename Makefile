...
build:
	GOPROXY=DIRECT CGO_ENABLED=0 go build $(BUILD_MOD) -o $(BINARY) ./systems/deliverydron/delivery_drone/cmd/delivery_drone
...
build-all:
	GOPROXY=DIRECT CGO_ENABLED=0 go build $(BUILD_MOD) -o /dev/null ./systems/deliverydron/delivery_drone/cmd/delivery_drone ./systems/deliverydron/stub_component/cmd/stub_component
